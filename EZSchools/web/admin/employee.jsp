            ...
            <div class="swMain" id="wizard">
                <div class="stepContainer" style="height: 296px;">
                    ...
                    <div id="step-1" class="content" style="display: block;">	
                        ...
                        <form class="form-control" onsubmit="return EmpcheckForm();" action="../process/registerProcess.jsp" method="post">
                            ...
                            <div class="col-md-6">
                                <div class="inline-form">
                                    ...
                                    <input type="text" id="dob" name="dob" class="input-style">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="inline-form">
                            ...
                            <div class="col-md-6">
                                <div class="inline-form">
                                    ...
                                    <input type="text" onblur="setUsername();" id="phone" name="phone" class="input-style" placeholder="Phone number"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="inline-form">
