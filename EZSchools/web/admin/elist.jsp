...
<script>
    function deleteItem(eid){
        ...
        if(status==true){
            window.location="forJs/remove.jsp?tid="+eid+"&ty=emp";
        }
    }
    function Deactivate(eid){
        var status = confirm("Are you sure you..??");
        if(status==true){
            window.location="forJs/deactivate.jsp?tid="+eid+"&ty=emp";
        }
    }
    function Activate(eid){
        var status = confirm("Are you sure you..??");
        if(status==true){
            window.location="forJs/activate.jsp?tid="+eid+"&ty=emp";
        }
    }
</script>
<div class="main-bg" >
                        ...
                        <table class="table table-striped table-bordered" id="stream_table">
                            ...
                            <tbody>
                                <%
                                    ...
                                    ArrayList alist = sb.getEmpList(sb);
                                    int i = 1;
                                    if (alist.size() > 0) {
