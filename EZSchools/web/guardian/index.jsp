<%
    ...
    if (((String) session.getAttribute("session_id") != null) && (type.equals("guardian"))) {
%>
<!DOCTYPE html>
<head>
    <style>
    ...
    <div class="wrapper">
        <header>
            ...
            <div class="welcome-user">
                ...
                <p>Welcome <%=(String) session.getAttribute("session_name")%></p>
            </div>
                ...
                <ul>
                    ...
                    <li><a  href="javascript:;"><i class="icon-book"></i>Employee Section</a>
                        <ul>
                            ...
                            <li><a href="index.jsp?page=elist"><i class="icon-list"></i>Empoloyee List</a></li>
                        </ul>
                    </li>
                    <li><a href="index.jsp?page=manage"><i class="icon-cogs"></i>Manage Class</a></li>
                    <li><a href="index.jsp?page=change"><i class="icon-key"></i>Change Password</a></li>
                    <li><a href="logout.jsp"><i class="icon-user"></i>Logout</a></li>
                </ul>
            </div>
