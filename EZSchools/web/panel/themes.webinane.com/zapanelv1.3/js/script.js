$(document).ready(function(){
	...
	//---------- This assigns an onclick event to each tab link("a" tag) and passes a parameter to the showHideTab() function
		...
		$(".clr-red").click( function(){
			$(this).parent().parent().parent().parent().parent().parent().addClass('red');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('purple');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('blue');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('green');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('orange');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('gray');
		});		

		$(".clr-blue").click( function(){
			$(this).parent().parent().parent().parent().parent().parent().removeClass('red');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('purple');
			$(this).parent().parent().parent().parent().parent().parent().addClass('blue');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('green');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('orange');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('gray');
		});		

		$(".clr-green").click( function(){
			$(this).parent().parent().parent().parent().parent().parent().removeClass('red');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('purple');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('blue');
		...
		$(".clr-orange").click( function(){
			$(this).parent().parent().parent().parent().parent().parent().removeClass('red');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('purple');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('blue');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('green');
			$(this).parent().parent().parent().parent().parent().parent().addClass('orange');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('gray');
		});		

		$(".clr-purple").click( function(){
			$(this).parent().parent().parent().parent().parent().parent().removeClass('red');
			$(this).parent().parent().parent().parent().parent().parent().addClass('purple');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('blue');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('green');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('orange');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('gray');
		...
		$(".clr-gray").click( function(){
			$(this).parent().parent().parent().parent().parent().parent().removeClass('red');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('purple');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('blue');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('green');
			$(this).parent().parent().parent().parent().parent().parent().removeClass('orange');
			$(this).parent().parent().parent().parent().parent().parent().addClass('gray');
		});		

		
		$(".ui-notify-close").click( function(){
			$(this).parent().slideUp();
		});	
		
		$(".reply-sec").click( function(){
			$(".reply-sec-display",this).slideDown();
		});	

		
		$(".pop-over a").click( function(){
			$(this).next('span').fadeToggle();
		});			

		
		$("#live-chat div").click( function(){
			$(".chat").slideToggle();
		});			
		...
		$(".gradient-theme-btn").click( function(){
			$(".widget-heading").addClass("gradient-gray");
			$(".widget-heading").removeClass("blue");
			$(".widget-heading").removeClass("red");
			$(".widget-heading").removeClass("green");
			$(".widget-heading").removeClass("orange");
			$(".widget-heading").removeClass("gray");
			$(".widget-heading").removeClass("purple");
		});		
		
		
		(function() {

		var quotes = $(".notify-fade");
		var quoteIndex = -1;
...
$(document).ready(function(){ 
				...
				$('.returning-visitor').easyPieChart({
                    animate: 1000,
					barColor: '#576879',
					trackColor: '#c8d2db',
					scaleColor: '#999999',
